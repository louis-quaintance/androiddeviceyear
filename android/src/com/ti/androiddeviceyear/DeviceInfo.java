...
/*
 * Copyright (c) 2015, Facebook, Inc. All rights reserved. This source code is licensed under the
 * BSD-style license found in the LICENSE file in the root directory of this source tree. An
...
/**
 * Helper class for accessing hardware specifications, including the number of CPU cores, CPU clock
 * speed and total available RAM.
 */
public class DeviceInfo {

    /**
     * The default return value of any method in this class when an error occurs or when processing
     * fails (Currently set to -1). Use this to check if the information about the device in
     * question was successfully obtained.
     */
