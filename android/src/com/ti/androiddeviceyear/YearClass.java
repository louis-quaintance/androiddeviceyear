package com.ti.androiddeviceyear;
...
public class YearClass {
    ...
    /**
     * Entry Point of YearClass. Extracts YearClass variable with memoizing. Example usage:
     * <p>
     *
     * <pre>
    ...
    private static int categorizeByYear(Context c) {
        ...
        if ((componentYears.size() & 0x01) == 1) { // Odd number; pluck the median.
            ...
            return componentYears.get(baseIndex) + (componentYears.get(baseIndex + 1) - componentYears.get(baseIndex))
                    / 2;
        }
    }

    /**
     * Calculates the year class by the number of processor cores the phone has. Evaluations are
     * based off the table below:
     * <table border="1">
     * <thead>
     * <tr>
     ...
     * </tbody>
     * </table>
     * @return the year in which top-of-the-line phones had the same number of processors as this
     *         phone.
     */
    ...
    /**
     * Calculates the year class by the amount of RAM the phone has. Evaluations are based off the
     * table below:
     * <table border="1">
     * <thead>
     * <tr>
